...
h1{{font-size:27px;line-height:1.15;margin:5px 0 5px;letter-spacing:-.5px}}.incident-title{{max-width:560px;color:#e2e8f0;font-size:11px;font-weight:600;margin:0 0 7px;overflow-wrap:anywhere}}.report-id{{font-family:ui-monospace,SFMono-Regular,Consolas,monospace;color:#cbd5e1}}
...
<div class="hero"><div class="hero-top"><div><div class="brand">SANITIALX SOC</div><div class="eyebrow">Security Operations Center · Incident Intelligence</div><h1>Incident Investigation Report</h1><div class="incident-title">{_text(report.get('title'))}</div><div class="report-id">{_text(report.get('report_id'))}</div></div><div class="hero-meta"><b>Generated</b><br>{_text(generated)}<br><span class="classification">CONFIDENTIAL · SOC USE</span></div></div></div>
