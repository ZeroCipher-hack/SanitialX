...
def test_professional_report_contains_core_soc_sections_and_escapes_input():
    ...
    for text in ("Incident Investigation Report","Executive Summary","Indicators of Compromise","MITRE ATT&CK Techniques","Asset / CVE Exposure Evidence","CVE-2026-1234","Response Timeline","SOAR Response Actions","Recommended Remediation","COLLECT_FORENSICS","APPROVED","analyst"):assert text in html
